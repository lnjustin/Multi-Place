...
4. Get a Google Directions API key <a href="https://developers.google.com/maps/documentation/directions/get-api-key" target="_blank">here</a>. Enable the Google Directions API. If you will use Life360 with States, also enable the Google Geocoding API. Google gives you $200 a month in credit, which translates to 20,000 API calls a month for free. That’s more than plenty to keep this free for you.
